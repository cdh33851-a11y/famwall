...
function buildScheduleOrganizerInstructions(): string {
  return [
    ...
    "# 또는 *가 비밀번호 값의 앞, 뒤, 중간에 들어 있으면 그 기호까지 원문 그대로 보존한다.",
    "'#2605#0723', '2605#0723', '*1234#'처럼 # 또는 *가 포함된 연속 문자열은 하나의 비밀번호이므로 절대 둘 이상으로 나누지 않는다.",
    "예를 들어 원문이 '공동현관 #2605#0723'이면 반드시 '공동현관: #2605#0723'으로 한 줄에 적고, '공동현관: 2605'와 '공동현관: 0723'으로 분리하지 않는다.",
